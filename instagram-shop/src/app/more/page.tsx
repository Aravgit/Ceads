    ...
    <div className="pt-16">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">More Information</h1>
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                <p className="text-gray-600">
                  ...
                  business days, while express shipping is available for next-day delivery.
                </p>
                <p className="text-gray-600">
                  International shipping is available to select countries. Shipping costs
